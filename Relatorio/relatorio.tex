...
O bloco \textit{cooler\_hal} é responsável pelo controle do ventilador ligado à placa. Ele conta com uma função de inicialização e uma função controla a velocidade do mesmo, através do módulo PWM.
